class PlayerBuilder {
    ...
    build(x, y) {
        ...
        var player = new GameObject().addTransform(x, y).addSprite(new Sprite().createAnimatedSprite(new PlayerAnimator(images, width, height))).addRigidBody(x + width / 4, y, width / 2, height);
